    ...
    expect(parseChangelogMarkdown(contents)).toMatchInlineSnapshot(`
      {
        "releases": [
          {
            "body": "[compare changes](https://github.com/saman-taghavi/pishiLogger/compare/v0.4.0...v0.4.1)
      ...
      - Nozomu Ikuta <nick.0508.nick@gmail.com>",
          ...
          {
            "body": "[compare changes](https://github.com/saman-taghavi/pishiLogger/compare/v0.3.5...v0.4.0)
